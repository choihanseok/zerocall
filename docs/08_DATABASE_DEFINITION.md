...
phone/email/password_hash/phone_verified_at/email_verified_at/last_login_at, AccountProfile/Agreement/Role/StatusHistory는 NOT_IMPLEMENTED. 전화번호·이메일 unique 정책은 원본에서도 후보이며 확정 전 구현하지 않는다. 기존 soft-deleted 레코드는 내부 일반조회에서 숨기되 원본과 PK는 보존한다.
